...
export default function Sidebar() {
  return (
    <aside id="default-sidebar" className="sticky top-0 left-0 z-40 w-72 h-screen transition-transform -translate-x-full sm:translate-x-0 border-r border-gray-200 dark:border-gray-700" aria-label="Sidebar">
